(function ($) {
    ...
    $(document).on('change', 'select.mweb-carousel-select', function () {
        var $this = $(this);
        var filterAuto = $this.closest('.widget').find('[data-select="mweb-filter-auto"]');
        var filterCustom = $this.closest('.widget').find('[data-select="mweb-filter-custom"]');
