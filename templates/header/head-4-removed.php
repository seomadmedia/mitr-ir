...
?>
<header <?php mweb_theme_schema::makeup('header'); ?> class="head_4"> 
	<div class="container">
		<div class="row">
			...
			<div class="col-6 col-sm-6 col-md-4">
				...
				<a href="<?php echo wc_get_endpoint_url('wishlists', '', $mweb_acc_url); ?>" class="head_wishlist_btn hs_icon"><i class="fal fa-heart"></i></a>
